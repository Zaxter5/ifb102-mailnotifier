...
def init():
    while True:
        editOrRun = input("Would you like to [E]dit or [R]un?")
        if editOrRun == "E":
            timeOrEmail = input("Would you like to change the check interval [T]ime or change your [E]mail? Or [C]ancel.")
            if timeOrEmail == "T":
                time_input = input("Please type your desired time in SECONDS:")
                ...
                email_input = input("Please type your Gmail address - this is case sensitive:")
                print(email_input)
